...
async def cmd_help(message: types.Message):
    ...
    help_text = (
        ...
        "🍌 **Nano Banana (Gemini)**\n"
        "• Flash (`gemini-2.5-flash-image`): AR любые, SD (без 2K/4K), референсы до лимита тарифа, диалог — нет, 70 NC\n"
        ...
        "💬 Диалог поддерживает только Pro.\n"
        "📎 Референсы поддерживают Flash и Pro (лимиты тарифа).\n\n"
